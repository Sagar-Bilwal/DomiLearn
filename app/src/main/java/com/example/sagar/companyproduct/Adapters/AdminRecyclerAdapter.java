...
public class AdminRecyclerAdapter extends RecyclerView.Adapter<AdminRecyclerAdapter.AdminViewHolder>
{
    ...
    public void onBindViewHolder(AdminViewHolder holder, int position)
    {
        ...
        else if(Objects.equals(taskNo.getReason(), " ")&& Objects.equals(taskNo.getStatus(), "Yes"))
        {
            holder.reason.setText("Order Not Updated by User");
        }
        else if(Objects.equals(taskNo.getReason(), " ")||(Objects.equals(taskNo.getReason(), "")))
        {
            holder.reason.setText("User has not visited the Company till now");
        }
        else
        {
            holder.reason.setText(taskNo.getReason());
        }
